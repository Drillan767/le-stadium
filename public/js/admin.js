...
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_materialize_css_dist_js_materialize_min_js__ = __webpack_require__(39);
...
$(document).ready(function () {
    ...
    $('#add_dish').click(function () {
        i++;
        $('#dish_field').append('' + '<tr id="row' + i + '" class="dynamic-added">' + '<td>' + '<input type="text" name="name[]" placeholder="Enter your Name" class="form-control name_list" required />' + '</td>' + '<td>' + '<input type="text" name="price[]" placeholder="Prix" class="form-control name_list" required />' + '</td>' + '<td>' + '<select name="category[]" required>' + '<option value="salade">Salade</option>' + '<option value="plat">Plat</option>' + '<option value="dessert">Dessert</option>' + '</select>' + '</td>' + '<td>' + '<button class="btn waves-effect waves-light red btn_remove" name="remove" id="' + i + '">X</button>' + '</td>' + '</tr>');
...
/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(1), __webpack_require__(1), __webpack_require__(1), __webpack_require__(5)))
